...
public class ProjetoPI {
    ...
    public static void main(String[] args) {
        ...
        int c=0, s=1, M[][]= new int [50][4], MM[][]= new int[50][2],d=0;  
    ...
    public static void cadastramento(int c,int M[][]){    
    ...
    public static void estatistica (int M[][], int c, int d, int MM[][]){
        ...
        int i,sala,cc1=0,cc2=0,cc3=0,ccc1=0,ccc2=0,ccc3=0,ccc4=0,p,pp=0,j=0,cccc,ccccc,A[]=new int [50],B[]=new int [50],C[]= new int [50],D[]=new int [50];
